...
`)),fi=F("span",{name:"MuiTouchRipple",slot:"Root"})({overflow:"hidden",pointerEvents:"none",position:"absolute",zIndex:0,top:0,right:0,bottom:0,left:0,borderRadius:"inherit"}),gi=F(di,{name:"MuiTouchRipple",slot:"Ripple"})(vt||(vt=Pe`
  opacity: 0;
  position: absolute;
...
`,No=f.li`
  ...
  border-radius: 8px;
  background: #f5f5f5;
`,Do=()=>n.jsxs("section",{children:[n.jsx("h2",{className:"hidden-title",children:"Сustomers"}),n.jsx(zo,{children:Vo.map(e=>n.jsx(No,{children:n.jsx("img",{src:e.img,alt:e.alt})},e.id))})]}),Vo=[{id:de(),img:`${pe}`,alt:"logo name"},{id:de(),img:`${pe}`,alt:"logo name"},{id:de(),img:`${pe}`,alt:"logo name"},{id:de(),img:`${pe}`,alt:"logo name"},{id:de(),img:`${pe}`,alt:"logo name"},{id:de(),img:`${pe}`,alt:"logo name"}],Go=()=>n.jsxs("main",{children:[n.jsx(Ao,{}),n.jsx(Do,{}),n.jsx(wn,{}),n.jsx(Ro,{}),n.jsx(Mn,{}),n.jsx(oo,{}),n.jsx(Ut,{})]});export{Go as default};
